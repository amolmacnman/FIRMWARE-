...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ATMEL_AT25_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ROM_START_OFFSET, 0x800);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_TX_PROCESSOR_STACK_SIZE, 900);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_FILL_BUFFER_SIZE, 256);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_IMAGE_BOOT_OFFSET, 0x800);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_BOOTLOADER_SIGNATURE_TYPE_ED25519, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_OS_REBOOT_BT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_FLASH_WRITE_BLOCK_SIZE, 16);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_BOOTLOADER_USES_SHA512, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_BOOT_MAX_ALIGN, 16);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_SW_GATEWAY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_SW_GATEWAY_NRF54L15_CPUAPP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_HW_NRF_UARTE22, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_HW_NRF_UARTE30, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EEPROM_AT25, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SPI_NOR_ACTIVE_DWELL_MS, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_22_INTERRUPT_DRIVEN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_22_NRF_TX_BUFFER_SIZE, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_30_INTERRUPT_DRIVEN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_30_NRF_TX_BUFFER_SIZE, 32);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_GRTC_SYSCOUNTER_SLEEP_MINIMUM_LATENCY, 1000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_TX_PWR_ANTENNA, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_UPDATE_FOOTER_SIZE, 0x4000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_IMG_ALLOW_CONFIRM_NON_ACTIVE_SLOT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_OS_RESET_HOOK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ROM_END_OFFSET, 0x4090);
